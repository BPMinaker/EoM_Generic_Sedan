...
itre = [-0.1, -0.45, r - 0.033863] # inner tie rod end
otre = [-0.1, -0.12, r] # outer tie rod end
...
kr = 30000
cf = 2000 # suspension damping, front
cr = 2000
krf = 1000 # anti-roll bar stiffness, front
krr = 500
# weight distribution
fwf = 0.5 # front weight fraction (i.e., b/(a+b)), you can modify this from 0.05 to 0.95
# braking
fbf = 0.6 # front brake fraction
